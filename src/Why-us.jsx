  ...
  return (
    <>
      <section className="why-us" id="why-us" style={{backgroundColor: '#F2F2F2', paddingTop:'60px'}}>
        <div className="container-fluid" style={{ padding:'0px 12px', margin:'0px 60px'}}>
            <div className="row" >
                <div className="col-lg-4 aos-init aos-animated" data-aos="fade-up" data-aos-delay="100" style={{marginTop:'24px'}}>
                    <div className="why-box">
                        <h2 >Why Choose Yummy</h2>
                        <p style={{ marginBottom: '30px'}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi labore ipsa doloremque exercitationem aperiam minus praesentium corporis sit. Voluptates ipsum doloribus, mollitia cupiditate, maxime corrupti eius accusantium hic sit fuga minus.</p>
                        <div className="text-center"><a href="#" className="more-btn" style={{padding: '8px 40px 10px', backgroundColor:'rgb(234, 46, 46)', textDecoration: 'none', color: '#ffffff'}}><span>learn More</span><i className="bi bi-chevron-right"></i></a></div>
                    </div>
                </div>

                <div className="col-lg-8 aos-init aos-animated" data-aos="fade-up" data-aos-delay="200" >
                    <div className="row">
